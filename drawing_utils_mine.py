...
#MODIFIED draws only connections
def draw_landmarks(
    image: np.ndarray,
    alpha: float,
  ...
  if connections:
    ...
    for connection in connections:
      ...
      if start_idx in idx_to_coordinates and end_idx in idx_to_coordinates:
        ...
        color_with_alpha = tuple([int(alpha * x) for x in drawing_spec.color])
        cv2.line(image, idx_to_coordinates[start_idx],
                 idx_to_coordinates[end_idx], color_with_alpha,
...
#       cv2.circle(image, landmark_px, circle_border_radius, color_with_alpha,
#                  drawing_spec.thickness)
#       # Fill color into the circle
#       cv2.circle(image, landmark_px, drawing_spec.circle_radius,
#                  color_with_alpha, drawing_spec.thickness)
