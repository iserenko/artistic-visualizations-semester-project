...
from drawing_utils_mine import DrawingSpec
...
#NEW
def get_default_pose_landmarks_style_mine() -> Mapping[int, DrawingSpec]:
  ...
  left_spec = DrawingSpec(
      color=_WHITE, thickness=_THICKNESS_POSE_LANDMARKS, circle_radius = 1)
